        ...
        btSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userName.equals("")){
                    ...
                    Toast.makeText(RegistrarActivity.this, "Insira a SENHA DO USÁRIO", Toast.LENGTH_SHORT).show();
                } else if (!pas1.equals(pas2)) {
                    Toast.makeText(RegistrarActivity.this, "As senhas não correspondendem ao login do usuário", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    if(res>0){
                        ...
                        Toast.makeText(RegistrarActivity.this, "inválida!", Toast.LENGTH_SHORT).show();
                    }
                }
